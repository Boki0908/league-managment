...
public class TeamsService {
	...
	public List<TeamCustom> getCustomTeams() {
		...
		// prvi parametar je tip Objekta - u ovom slucaju Team, drugi-param je
		// proizvoljno ime, : treci- popunjena lista
	...
	private TeamCustom populateTeamsCustom(Team team, List<TeamsDrivers> teamsDrivers) {
		...
		// posebvna provera da slucajno lista nije prazna ili null pa da ne pukne
		// program
		// StringUtils je biblioteka koja nam daje mnogo pomoci za obradu Stringova,
		// Listi itd...
		if (!StringUtils.isEmpty(teamsDrivers)) {
			for (TeamsDrivers drv : teamsDrivers) {
				...
				// nego samo odmah nad klasom DriverCustom gradim kroz builder metodu ceo
				// objekat
